...
def export_features(
    ...
    *,
    ...
    if any(x is not None for x in candidate_options):
        raise ValueError('identity candidate requires the explicit historical maintenance exporter: tools.incidents.identity_research_columns')
...
def main() -> int:
    ...
    parser.add_argument("--identity-candidate", help="Retired here; use tools.incidents.identity_research_columns")
    parser.add_argument("--identity-price-layer", help="Retired historical candidate option")
    parser.add_argument("--identity-receipts", help="Retired historical candidate option")
