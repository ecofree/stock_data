...
CAPABILITY_RULES: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "decision": "port",
        "target_adapter": "trade_system.v2.strategies explicit policy events",
    ...
    },
    {
        ...
        "decision": "port",
        "target_adapter": "trade_system.v2.decisions",
    ...
    },
    {
        ...
        "decision": "port",
        "target_adapter": "trade_system.v2.research_followup exact-session price targets",
    ...
    },
    {
        ...
        "decision": "reference",
        "target_adapter": "trade_system.v2.decisions explicit paper risk policy",
...
def _audit_stock_data(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "files": _audit_project_files(
            root,
            [
                "trade_system/schema.py",
                "trade_system/v2/strategies.py",
